...
Gt;//**************result  11******deltaGt can get from JOIN with deltaC
...
dClosest;
ub1 := dClosest; //***************result 12 ********ub == dClosest
...
lbs1 ;//***************result 13 == lb of each group
...
resultFinal2 := PROJECT(rest2, TRANSFORM(Types.NumericField, SELF.id := LEFT.id; SELF.number := LEFT.cid; SELF.value :=distancePair(LEFT.id, LEFT.cid); ));
resultFinal2;
