...
// #WORKUNIT('name', 'YinyangKMeansv4_update_test:THOR::DP100:30:0.3'); 
// YinyangKMeans:=ML.yinyang.drafts.yinyangkmeansv4_updatestep_test.YinyangKMeans(dDocuments,dCentroids,30,0.3);

// #WORKUNIT('name', 'YinyangKMeansv4_update_test:THOR::USCensus:30:0.3'); 
// YinyangKMeans:=ML.yinyang.drafts.yinyangkmeansv4_updatestep_test.YinyangKMeans(dDocuments,dCentroids,30,0.3);

// #WORKUNIT('name', 'YinyangKMeansv4_update_test:KEGG:30:0.3'); 
// YinyangKMeans:=ML.yinyang.drafts.yinyangkmeansv4_updatestep_test.YinyangKMeans(dDocuments,dCentroids,30,0.3);

// #WORKUNIT('name', 'YinyangKMeansv4_update_test::IRIS:30:0.3'); 
// YinyangKMeans:=ML.yinyang.drafts.yinyangkmeansv4_updatestep_test.YinyangKMeans(dDocuments,dCentroids,30,0.3);

//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%below is the test for yinyangkmeans v4 with various input parameters %%%%%%%%%%%%%%%%%%


// 1. change the number of centroids. 
//KEGG

dDocumentMatrix := kegg.input;
dCentroidMatrix := kegg.input[1..50];

ML.ToField(dDocumentMatrix,dDocuments);
ML.ToField(dCentroidMatrix,dCentroids);


#WORKUNIT('name', 'YinyangKMeansv4_update_test:50:10:KEGG:50:0.3'); 
YinyangKMeans:=ML.yinyang.drafts.yinyangkmeansv4_updatestep_test.YinyangKMeans(dDocuments,dCentroids,50,0.3);
