...
//Add local filter to yinyangkmeansv3_update: the results compliance with IRIS set and KEGG set
//The testing file is the yinyangkmeansv4_localfilter_test.ecl in the drafts folder
//Version: Final 
...
EXPORT yinyangkmeansv4_localfilter := MODULE
