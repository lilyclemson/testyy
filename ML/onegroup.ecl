...
c3:=3;			
			...
			lbs3_temp := PROJECT(lbs2,TRANSFORM(Mat.Types.Element, SELF.value := ABS(LEFT.value - deltaG2); SELF := LEFT));
...
c4:=4;		//**	
			...
			lbs4_temp := PROJECT(lbs3,TRANSFORM(Mat.Types.Element, SELF.value := ABS(LEFT.value - deltaG2); SELF := LEFT));
            ...
            lbs4 := lbs4_unchanged + lbs4_changed;			
